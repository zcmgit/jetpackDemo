...
class RoomFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        userAdapter = viewModel.userAdapter.apply {
            setOnItemClickListener(object : UserListAdapter.OnItemClickListener {
                override fun OnItemClick(position: Int, userEntity: UserEntity) {
                    ...
                    Navigation.findNavController(view).navigate(R.id.action_roomFragment2_to_addUserInfoFragment3, bundle)
                }
        ...
        insertBtn.setOnClickListener {
            Navigation.findNavController(it).navigate(R.id.action_roomFragment2_to_addUserInfoFragment3)
        }
        //删除所有数据数据
