package com.example.jetpack.roomrxjava.adapter
...
import com.example.jetpack.databinding.UserListRoomRxjavaItemBinding
...
class UserListAdapter : RecyclerView.Adapter<UserListAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        var viewDataBinding = DataBindingUtil.inflate<UserListRoomRxjavaItemBinding>(LayoutInflater.from(parent.context), R.layout.user_list_room_rxjava_item, parent, false)
